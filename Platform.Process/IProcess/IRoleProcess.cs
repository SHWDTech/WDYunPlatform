...
namespace Platform.Process.IProcess
{
    ...
    public interface IRoleProcess
    {
        ...
        IEnumerable<IWdRole> GetAllModels();
        ...
        IEnumerable<IWdRole> GetModels(Func<IWdRole, bool> exp);
        ...
        int GetCount(Func<IWdRole, bool> exp);

        /// <summary>
        /// 新建默认数据角色
        /// </summary>
        /// <returns>默认数据角色</returns>
        IWdRole CreateDefaultModel();
        ...
        IWdRole ParseModel(string jsonString);
        ...
        Guid AddOrUpdate(IWdRole model);
        ...
        int AddOrUpdate(IEnumerable<IWdRole> models);

        /// <summary>
        /// 删除对象
        /// </summary>
        /// <param name="model">被删除的对象</param>
        void Delete(IWdRole model);
        ...
        int Delete(IEnumerable<IWdRole> models);
        ...
        /// <returns>存在返回True，不存在返回False</returns>
        bool IsExists(Func<IWdRole, bool> exp);
        ...
        void MarkDelete(IEnumerable<IWdRole> models);
        ...
        void SetEnableStatus(IWdRole model, bool enableStatus);
        ...
        /// <param name="enableStatus">Ture设置角色状态为启用，False设置角色状态为未启用</param>
        void SetEnableStatus(IEnumerable<IWdRole> models, bool enableStatus);
    }
}