...
namespace Platform.Process.IProcess
{
    ...
    public interface IUserProcess
    {
        ...
        IEnumerable<IWdUser> GetAllModels();
        ...
        IEnumerable<IWdUser> GetModels(Func<IWdUser, bool> exp);
        ...
        int GetCount(Func<IWdUser, bool> exp);

        /// <summary>
        /// 新建默认数据角色
        /// </summary>
        /// <returns>默认数据角色</returns>
        IWdUser CreateDefaultModel();
        ...
        IWdUser ParseModel(string jsonString);
        ...
        Guid AddOrUpdate(IWdUser model);
        ...
        int AddOrUpdate(IEnumerable<IWdUser> models);

        /// <summary>
        /// 删除对象
        /// </summary>
        /// <param name="model">被删除的对象</param>
        void Delete(IWdUser model);
        ...
        int Delete(IEnumerable<IWdUser> models);
        ...
        /// <returns>存在返回True，不存在返回False</returns>
        bool IsExists(Func<IWdUser, bool> exp);
        ...
        void MarkDelete(IEnumerable<IWdUser> models);
        ...
        void SetEnableStatus(IWdUser model, bool enableStatus);
        ...
        /// <param name="enableStatus">Ture设置角色状态为启用，False设置角色状态为未启用</param>
        void SetEnableStatus(IEnumerable<IWdUser> models, bool enableStatus);
    }
}