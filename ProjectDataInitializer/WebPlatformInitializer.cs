...
{
    public class PlatFormInitProjectInitializer : DropCreateDatabaseAlways<RepositoryDbContext>
    {
    ...
    public class PlatFormDevelopInitializer : DropCreateDatabaseIfModelChanges<RepositoryDbContext>
    {
        protected override void Seed(RepositoryDbContext dbContext)
        {
            base.Seed(dbContext);
    ...
    public class PlatFormProductionInitializer : CreateDatabaseIfNotExists<RepositoryDbContext>
    {
        protected override void Seed(RepositoryDbContext dbContext)
        {
            base.Seed(dbContext);
