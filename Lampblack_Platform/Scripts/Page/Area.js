...
$(function () {
    ...
    function doRemoveArea(param) {
        ...
        base.AjaxGet('Management/DeleteArea', { 'Id': area.Id }, function () {
            AreaInfo = AreaInfo.filter(function (obj) {
                return (obj.Id === area.Id || obj.ParentNode === area.Id || (obj.Parent != null && obj.Parent.ParentNode === area.Id));
            });
            $(li).addClass('removed');
            setTimeout(function () {
                if ($(li).is('.active')) {
    ...
    $('.area-insert-btn').on('click', function () {
        ...
        if (IsNullOrEmpty(areaName) || !currentAreas.every(function (obj) { return obj.ItemValue !== areaName; })) {
